...
public class RegeisterSurface extends JFrame implements ActionListener{
        public static void main(String[] args) {
			new RegeisterSurface();
		}
	   ...
	   MsUserservice Msus = new MsUserservice();
	    ...
	    RegeisterSurface(){	    	
		 ...
		 regeister = new JButton(new ImageIcon("th0image/zhuce2.png"));
		 regeister.setBounds(100, 530, 80, 30);
		 regeister.addActionListener(this);
		 this.add(regeister);
		 cancel = new JButton(new ImageIcon("th0image/quxiao.png"));
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == varCodeb){
			    ...
			    try {
					boolean flag = Msus.regeister(msr);
					if(flag){
